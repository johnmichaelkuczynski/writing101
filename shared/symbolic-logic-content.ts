  ...
  sections: [
    {
      ...
      content: `<p class="document-paragraph mb-4 text-indent-2rem">Introduction to Symbolic Logic
J.-M. Kuczynski
...
Modality
2.3 Principles and theorems of formal logic</p>
<h3 class="text-lg font-semibold mt-6 mb-3">3.0 Some meta-logical principles: Model theoretic entailment
...
7.7 Compactness vs. continuity</h3>
<h3 class="text-lg font-semibold mt-6 mb-3">7.8 Set-measure
...
owns 127 cars. Q: Smith is very wealthy.)
 ...
 P confirms Q if P increases the likelihood that Q is true.</h3>
<p class="document-paragraph mb-4 text-indent-2rem">Given only that P confirms Q, it doesn't follow that acceptance of P
...
1.3 Induction in relation to confirmation</p>
<p class="document-paragraph mb-4 text-indent-2rem">P confirms Q if the probability of Q, given P, is higher than the probability of
...
Indeed, given any true proposition Q, there are infinitely many falsehoods</p>
<p class="document-paragraph mb-4 text-indent-2rem">P such that Q is a logical consequence of P.
...
premises and a true conclusion.</p>
<h3 class="text-lg font-semibold mt-6 mb-3">1.5 Two kinds of induction
...
In some cases, the conclusions of inferences to the best explanation aren’t</h3>
<p class="document-paragraph mb-4 text-indent-2rem">themselves causal statements. Our knowledge that water consists of H2O
...
1.7 Two kinds of entailment</p>
<p class="document-paragraph mb-4 text-indent-2rem">Just as there are two kinds of inductive inference, so there are two kinds of
...
means that
(2) If Smith has four cars, then Smith has more than one car.</p>
<p class="document-paragraph mb-4 text-indent-2rem">Thus, “P→Q” can be taken to mean that P implies Q. Thus “→” expresses
implication.
...
and
(5) supposing that it’s the case that snow is white and that grass is green,</p>
<p class="document-paragraph mb-4 text-indent-2rem">it follows that grass is green.
...
This means that
“~(snow is not white)”
is meaning-equivalent with</p>
<p class="document-paragraph mb-4 text-indent-2rem">“it is not the case that snow is white.”
Be it noted that
“~(snow is not white)”
...
involved the use of methods that, being ad hoc, could be arrived at only</p>
<p class="document-paragraph mb-4 text-indent-2rem">through a creative insight and logical inference. Such Herculean measures
...
pairs of sentences.)
When an operator O occurs in some sentence S, where S has one or more</p>
<p class="document-paragraph mb-4 text-indent-2rem">sentences as proper parts, the scope of that occurrence is identical with the set
...
person).
Negation in relation to the use of parentheses
Parentheses make it clear what is being negated. For example,</p>
<p class="document-paragraph mb-4 text-indent-2rem">(A) ~snow is white or grass is green
...
does say that it’s necessarily the case that P implies Q.</p>
<p class="document-paragraph mb-4 text-indent-2rem">The non-exclusive meaning of “or”
...
is defined thus:
P/Q≡DF~P and ~Q</p>
<p class="document-paragraph mb-4 text-indent-2rem">Hence the following theorems:
~P↔P/P
P↔(P/P)/(P/P)
(P and Q) ↔(P/P)/(Q/Q)
(P or Q)↔(P/Q)/(P/Q)
...
P: x is a heavy smoker</p>
<p class="document-paragraph mb-4 text-indent-2rem">certainly confirms
...
is</p>
<p class="document-paragraph mb-4 text-indent-2rem">“If Bob is not a mammal, then Bob is not a dog.”
...
conditional.)</p>
<p class="document-paragraph mb-4 text-indent-2rem">A sentence-level operation is truth-preserving if, when given a true
...
(iii) P is true and Q is true.
It is only if
(iv) P is true and Q is false</p>
<p class="document-paragraph mb-4 text-indent-2rem">that P does not materially imply Q.
...
it is causally necessary that</p>
<p class="document-paragraph mb-4 text-indent-2rem">(ii) The fire flared up.
...
Commentary: Though it has been questioned, this principle is clearly correct.</p>
<p class="document-paragraph mb-4 text-indent-2rem">Given any object x, x has the property of being identical with x. So, given
...
Any given statement is either true or false.</p>
<p class="document-paragraph mb-4 text-indent-2rem">What isn’t true or false is not a statement.
...
No statement is both true and false.</p>
<p class="document-paragraph mb-4 text-indent-2rem">The class of statements that are both true and false is empty.
...
replace the occurrence of “Q” with “Smith is a mammal,” the result is SD,</p>
<p class="document-paragraph mb-4 text-indent-2rem">not SD#. There are no sentences such that, if the sentence-level variables in
...
doesn’t entail Q.</p>
<p class="document-paragraph mb-4 text-indent-2rem">8. ((P→Q) and (Q→R))→(P→R) (If P entails Q and Q entails R, then P
entails R.)
...
A statement isn’t true unless the negation of its negation is true.</p>
<p class="document-paragraph mb-4 text-indent-2rem">Premise: Smith is a professor.
...
other.</p>
<p class="document-paragraph mb-4 text-indent-2rem">Premise: Either Jones is a plant or Smith is in the house.
...
18. ~Q→((P→Q)→~P)</p>
<p class="document-paragraph mb-4 text-indent-2rem">Nothing but falsity entails falsity.
19. (Q→(P and ~P))→~Q.
...
1M. P→#P.
Whatever is actual is possible.</p>
<p class="document-paragraph mb-4 text-indent-2rem">2M. □P→P.
...
or Q) can be true in any possible world if each of P and Q is false in every</p>
<p class="document-paragraph mb-4 text-indent-2rem">possible world.
7M.(□P and #~Q)→~(P→Q).
...
11M.~□P→(P→Q)
Given any statement at all, be it true or false, there is no necessarily false</p>
<p class="document-paragraph mb-4 text-indent-2rem">statement that doesn’t entail it.
...
even though the two propositions do not, apart from that, have anything to do</p>
<p class="document-paragraph mb-4 text-indent-2rem">with each other.
...
concerning entailment? Because MT is extensionally correct. In other words,</p>
<p class="document-paragraph mb-4 text-indent-2rem">for any statements P and Q, P entails Q iff there is no possible circumstance
...
only if “entails” (i.e. “→”) is taken to refer to model-theoretic entailment.</p>
<h3 class="text-lg font-semibold mt-6 mb-3">3.1 Formal entailment
...
marked difference between, on the one hand, the relation that holds between</h3>
<p class="document-paragraph mb-4 text-indent-2rem">P1 and Q1 and, on the other hand, the relation that holds between:
P2: 1 + 1 = 2
and
...
P1 is syntactically just like P3, and Q1 is syntactically just like Q3. But there is</p>
<p class="document-paragraph mb-4 text-indent-2rem">no legitimate inference from P3 to Q3; and since those sentences are
...
This is all very well. But it’s patently obvious that you can’t infer the truth</p>
<p class="document-paragraph mb-4 text-indent-2rem">of P from that of Q, or vice versa. In general, model-theoretical entailment is
...
informal truth.</p>
<p class="document-paragraph mb-4 text-indent-2rem">Second reason: Formal truths, and thus formally true entailments, are
...
3.7 Entailment not a limiting case of confirmation</p>
<p class="document-paragraph mb-4 text-indent-2rem">For P to entail Q is not for P to confirm Q to the highest possible
degree.
...
(v) all of the above</p>
<p class="document-paragraph mb-4 text-indent-2rem">The answer is (v). We will now outline the reasons for this. (These reasons
...
propositions. In some cases, e.g. “2+2 equals 4”, the function in question is a</p>
<p class="document-paragraph mb-4 text-indent-2rem">constant function: any two tokens of that sentence-type encode the same
...
Philosophy, any assistance that knowledge of formal logic can provide one in</p>
<p class="document-paragraph mb-4 text-indent-2rem">the way of acquiring knowledge is parasitic on one’s knowledge of informal
...
that, the structure of that concept being what it is, any proposition of that</p>
<p class="document-paragraph mb-4 text-indent-2rem">form must be true. Thus, your acceptance of (3) is based on your acceptance
...
(3) root-x is irrational.</p>
<p class="document-paragraph mb-4 text-indent-2rem">If we assign the number nine to x, (1) and (2) come out true; but (3) does
...
(4) y bears R to z.
(5) z is a phi.
(6) R is “transitive” (if a bears it to b, and b bears it to c, then a bears it to</p>
<p class="document-paragraph mb-4 text-indent-2rem">c).
...
mere awareness.</p>
<p class="document-paragraph mb-4 text-indent-2rem">The conversion of non-propositional (observational, objectual) content into
...
It follows that there are analytic truths (e.g. the negation of 1), and also</p>
<p class="document-paragraph mb-4 text-indent-2rem">that we have knowledge of analytic truths (e.g. our knowledge of the
negation of 1).
6.0 Set-theoretic characterizations of truth, meaning, and entailment
...
(3) “Sam is tall.”</p>
<p class="document-paragraph mb-4 text-indent-2rem">If it is assumed that P’s composition parallels S’s, then P must be assumed
...
information.</p>
<p class="document-paragraph mb-4 text-indent-2rem">Not only is P5 a consequence of P; P is a consequence of P5. They are
...
and z of K, ¬xRx (x doesn’t bear R to itself: R is non-reflexive), asymmetric</p>
<p class="document-paragraph mb-4 text-indent-2rem">(xRy→¬yRx) (y doesn’t bear R to x if x bears R to x: R is asymmetric) and 
...
meaning that kn={p/q: p+q=n} (e.g. k5={1/4,4/1,2/3,3/2}, and where ρ is the</p>
<p class="document-paragraph mb-4 text-indent-2rem">relation borne by km to km+1, for arbitrary m.
...
uninterpreted calculus (any formal language), is modeled by a structure that is</p>
<p class="document-paragraph mb-4 text-indent-2rem">structure-identical with ℕ.
...
7.7 Compactness vs. continuity</p>
<p class="document-paragraph mb-4 text-indent-2rem">A series S is compact if it is not discrete. ( ℚ,<) is compact. S is
...
Since [ ℚ]=[ ℕ], where [k] is k’s cardinality, ℚis as measurement-useless</p>
<p class="document-paragraph mb-4 text-indent-2rem">as ℕ. And since [ ℝ] is by definition the number of the smallest non-
