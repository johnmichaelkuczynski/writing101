  ...
  sections: [
    {
      ...
      content: `Dictionary of Analytic Philosophy J.-M. Kuczynski, PhD
...
Ambiguity vs. vagueness: Whereas an expression is ambiguous if it is assigned meaning by more than one semantic rule, an expression is “vague” if, supposing it unambiguous, it is assigned meaning by no well-defined semantic rule, and if, supposing it ambiguous, one of its disambiguations is assigned meaning by no well-defined semantic rule. Someone with zero hairs is definitely “bald,” and someone with a million hairs (provided that they’re suitably located and have the requisite thickness) definitely is “not bald.” But there are many people with an intermediate number of hairs with respect to whom neither “bald” nor “not bald” is clearly applicable. Since, therefore, the

semantics of “bald” is given by a rule that is undefined for these intermediate cases, “bald” is vague.
...
Others hold that vagueness is a property of the thing known, and not, at least not merely, of our knowledge of it. Those who hold this are said to believe in “objective” vagueness, the reason being that they believe vagueness to be a property of objects, as opposed to our methods of representing them.[1] According to this view, there may be no fact as to

whether Pat is a male or not or as to whether Pat is kind or not, etc. If this is right, then the law of excluded middle (any given proposition P is either 100% true or 100% false) is false.
...
a proposition’s identity is a function of what it entails and also of what entails it. If proposition P1 entails P2, but P3 does not, or P2 entails P1 but not P3, then P1 and P3 are ipso facto different propositions. Thus, the very idea of a
...
A priori: Knowledge is a priori if one has it, not in virtue of any observations that one has made, but in virtue of one’s innate cognitive structure of one’s mind. See “empirical knowledge.”
...
Given the axiom of comprehension, one of those two statements must be true. Since the axiom of comprehension therefore entails a contradiction, it is false. How exactly it must be modified is a matter of debate. See “axiom,” “property,” and “set.”
...
Axiomatization: To axiomatize a discipline is to identify a small number of propositions and a small number of inference-rules such that all of the results of that discipline follow from those propositions by means of those inference

rules. An axiomatization of a discipline is what results when it is successfully axiomatized. See “inference rule.”
...
term “condition,” and the expression “to actualize a concept” is synonymous with the expression “to fulfill a condition.”)
...
phonetically marked, are nonetheless present, and make it a complex expression.
...
If the meaning of a sentence S were determined by its “conceptual
...
Counterfactual analysis of causality: The position that x caused y to occur just in case, if x hadn’t happened, y wouldn’t have happened. According to this view, for the button’s being pushed to cause the elevator to come is for it to be the case that the elevator wouldn’t have come if the button hadn’t been pushed. In Chapter 17, it is shown why this view is false.
...
Definition by abstraction: In some cases, it can be said what it is for two things, x and y, to share some property P without using any expression that

refers to P. In such cases, it is possible to translate statements in which expressions referring to that property occur into statements in which such expressions don’t occur; and when this is done, the property in question is thereby defined in abstraction.
...
Denote:	As	we’ll	use	them,	the	terms	“denote”	and	“refer	to”	are synonymous, the same therefore being true of “denotation” and “referent” are
...
Duhem-Quine thesis: The thesis, which was advocated by W.V.O. Quine (1908–2001)[2], that no theory does either a better job or a worse job than any other theory of modeling any given body of data. In other words, given any body of observations B and given any two theories T and T*, T does no better and no worse a job than T* of modeling B.
...
Epistemic operator: An epistemic operator is one that, when joined with a sentence, yields a sentence that describes somebody’s beliefs or thoughts or feelings about the proposition expressed by the original sentence. Thus, “Jerry believes” is an epistemic operator, since, when placed in front of “that
...
Existential generalization (first meaning): It’s obvious that some sentences have the form “there is at least one thing that has property phi.” Here are some examples:
...
The differences between (iii) and (iii*) aren’t relevant to what we’re doing. As far as we’re concerned, they’re the same statement.
...
This is because (i) is what results when the variables in (iii) are replaced with constants, and so is (ii). In general, for two sentences S1 and S2 to have

the same form is for there to be some open-sentence S3 such that each of S1 and S2 is what results when the free variables in S3 are replaced with constants.

Formal entailment: See “formal truth.”

Formal truth: Formal truth is a property of sentences.[3] A sentence is formally true if every sentence having the same form is true. So “if Bill is tall, then it is not the case that it is not the case that Bill is tall” is formally true, since every sentence of the form “if S, then not S” is true. That sentence is also an example of a formal entailment. S1 formally entails S2 if the

sentence “if S1, then S2” is formally true.

Formalization: To formalize a discipline is to identify a set of open- sentences such that every proposition belonging to that discipline is either an

instance of one of those open-sentences or is a formal consequence of some interpretation of those open-sentences.
...
Hedonism (first meaning): The psychological doctrine that nobody can do anything other than pursue his or own pleasure. One problem with this doctrine is that not all forms of well-being are identical with the experiencing of pleasure. In fact, not all forms of enjoyment are identical with pleasure. I enjoy playing tennis. I experience pleasure when I have a few beers. My agency is implicated in the enjoyment I derive from tennis. The joy I derive from tennis is joy that I earn. By contrast, the joy I derive from alcohol is not joy that I earn. My agency isn’t involved. (My agency is involved in lifting the bottle to my mouth. But whereas that act is only a means to the actual source of pleasure—namely, the biochemical reactions that take place in my liver—the act of hitting a good backhand is itself a source of joy; it is constitutively, as opposed to merely instrumentally, involved in the joy I experience when I play tennis.) The word “pleasure” denotes enjoyment of this (non-agential) kind. The contempt that puritans have for pleasure is rooted in the fact that, whereas one’s agency and, therefore, one’s self are implicated in the joy that (for example) playing tennis brings, they are not implicated in the joy brought by narcotics-use and (with some qualifications) by sexual activity. So even though it probably isn’t psychologically healthy to have such a severe attitude towards such pleasures, the puritan’s view of

them embodies the important insight that, so far as one seeks pleasure, one seeks an effacement of self. Thus, a certain respect for human beings (qua agents) is inherent in the puritan’s view, and a respect for people (qua agents) is absent from the hedonist’s view. Where the puritan goes wrong is in his failure to see that a psychobiological prerequisite for mental health, and thus for retention of one’s agency, is a certain amount of passive gratification.
...
Incompatible: P and Q are incompatible if they can’t both be true. Thus, P and Q are incompatible if, supposing that the one is true, the other is false. So JM is a philosophy professor is incompatible with JM is not an instructor of any kind, since they cannot both be true. See “compatible.”
...
If a class has only finitely many members, then it is possible to give an enumerative definition of it. Consider the class of even numbers greater than zero but less than 10. It can be enumeratively defined as the class that
...
“the property of snoring is un-instantiated.”
...
, S2 gives S1’s logical form. See “entailment” and “meaning vs. entailment- relations.”[4] See “logically perfect language.”
...
sufficient for sameness of meaning. For any x, ‹x is a unique even prime› is equivalent with ‹x is the unique number n such that n = 2 if there is no completeness proof for arithmetic and n = 3 otherwise.› Neither sentence entails anything not also entailed by the other. But those sentences obviously differ in meaning.
...
Anything within an expression governed by an operator is said to fall within the scope of that operator. In (ii), “France” falls within the scope of “it

is possible.” In (iii), “two” falls within the scope of “Jerry believes that.” See “operator” and “epistemic operator.”
...
To answer these questions is to provide an “interpretation” of these expressions. An “interpretation” of a set of open-sentences is thus an assignment of definite meanings to the undefined or partially defined expressions occurring in it. If, given a particular interpretation X (1)–(3) come out true, X is a “model” of (1)–(3). If, given X, (1)–(3) comes out false, then X doesn’t model them.
...
more than one parent, which is false; and (3) says that grandparents are immediate parents, which is false.
...
Mutatis mutandis: This means provided that the relevant changes are made. Suppose that you and I have different employers and also that your boss hates my boss with such vitriol that he will reward anyone who harms my boss in any way. In that case, the statement: “I’ll get fired if I punch my boss, and you’ll get fired if you do the very same thing” is false. Supposing that I punch my boss, your doing the very same thing would consist in your punching my boss, which wouldn’t get you fired. But if you were to punch your boss, you would get fired. Thus, the right statement is: “I’ll get fired if I punch my boss, and you’ll get fired if you do the very same thing mutatis mutandis.”
...
Negation: The negation of P is not-P. So the negation of a proposition is the statement  that  says  that  P  is  false.  (Ockham  uses  the  obsolete  term
...
“snow” occurs three times (i.e., there are three occurrences of it) in the following sentence: “Jim likes snow and I love snow but Mary hates snow.” See “expression-token.”
...
A bound variable is a variable that isn’t free. Thus, a bound variable is one that is assigned a referent by the context or by preceding material. Consider the sentence:
...
him to the corresponding generalization, viz. for any sentences P and Q, ‹P and Q› entails ‹P. › But ‹P and Q› and ‹P› are not sentences; they’re open- sentences; they’re sentence-like entities that contain free variables and, unlike real sentences, are therefore neither true nor false.
...
S is meaningful; in fact, it’s correct (or at least could be, given certain reasonable assumptions about the individuals in question). Let O be the occurrence in S of “I now pronounce you man and wife.” If O cannot be meaningfully supposed true, S is meaningless, and therefore neither true nor false. Bearing this in mind, let O* be some occurrence of “I now pronounce you man and wife” that is occurring on its own. O and O* obviously have the same meaning. Since O is capable of being meaningfully supposed true, the same is true of O*, and Austin is therefore wrong to say otherwise.
...
universal. But it’s distinct from the number two itself. The numeral “2” is, for reasons that we discussed a little while ago, a property of certain ink marks and bursts of sounds. (Those ink marks, etc., are tokens of that numeral.) But the number two is a property of pairs of objects. “2” is no more identical with the number two than the name “John-Michael” is identical with the person John-Michael.
...
identical with any mental entity. To deny this would be to affirm the absurdity that there is a mental thing which isn’t any particular mental thing.
...
Why not everything? Because not everything mental is a propositional attitude. Nothing that isn’t content-bearing is a propositional attitude. (To say of something mental that it’s “content-bearing” is to say that it bears some

kind of message. So my current visual perception is content-bearing, since it tells me that there’s a computer screen in front of me. My headache isn’t content-bearing, since it doesn’t bear any message; it’s merely felt.) And many mental entities that are content-bearing aren’t propositional attitudes, the reason being that not all contents are propositions. See “propositions.”
...
Quantifier: An expression that, when coupled with a predicate yields a sentence saying how many things of a given kind have that property. A predicate may roughly be said to be an expression denoting a property (e.g., “snore,” “is tall”). (Why only roughly? See below.) “All people” is a quantifier, since, when coupled with “snore,” which denotes the property of snoring, yields “all people snore,” which says how many things of a certain kind have the property of snoring. “No fish” is a quantifier since, given the

expression snore, yields the sentence “no fish read Shakespeare,” which says how many things of a given kind have the property of reading Shakespeare.
...
Given that all quantifiers are connectives, it follows that all quantified generalizations are considered to be molecular propositions. See “quantified generalization.”

Quasi-quotation marks: In logic and the philosophy of language we often wish to talk about whole classes of sentences having a given form. We might
...
—we often wish to talk, not about snow (the substance), but “snow” (the word that substance).We do this by putting quotation marks around the expression to which we refer. So “snow” refers to the word that refers to the substance. See “quasi-quotation marks.”

Rationalism: The doctrine that not all knowledge is derived from sense- perception, the reason being that some knowledge is acquired through the analysis of concepts. Rationalists typically hold that knowledge is a prerequisite for our acquiring sensory information and also for our making

any inferences from it. Since such knowledge couldn’t possibly be observation based, it must have some other basis, this other basis being “pure reason.” Rationalists hold that knowledge of logical norms is non-perceptual, their argument being that sense-perception apprises us of what is, not of what ought to be (even in a narrowly logical sense). See “empiricism.”
...
In an utterance of the sentence “when I was discussing the difference between real virtue and feigned virtue, I was referring to your father,” the occurrence of the word “referring” picks out a characteristic of a certain speech act. Given some object O, a given act A that is performed by so and so is a case of so and so’s referring to O if, in performing A, it was so and so’s intention to make a statement about O. Let’s refer to this sort of reference as “reference*.”

In the sentence, “the name ‘Socrates’ refers to a certain philosopher,” the occurrence of the word “refers” picks out a property of expressions, not of actions. To say that an expression E refers to some object O is to say that, in virtue of containing E, a sentence ipso facto concerns O. “Socrates” refers to Socrates because, in virtue of having the form “...Socrates...,” a sentence says that Socrates has...x...(“Socrates is tall” says that Socrates has the property of being a thing x such that x is tall. “Plato admires Socrates” says that Socrates

has the property of being a thing x such that Plato admires x.) Let us refer to this sort of reference as “reference#.”

Some authors[5] have tried to show that reference# was identical with reference* or, at the very least, capable of being understood in terms of it. This is radically absurd.[6] Reference* presupposes reference#. Nobody could refer* to anything unless there were already meaningful expressions and, therefore, referring# terms. In Chapter 4, Sections 5.3.2–5.3.4, it is explained

why this is so. (So far as I know, it was John Searle, in his classic (1966) work Speech Acts, who made this important point for the first time in print.)
...
Sentential force: Some sentences are true or false (e.g., “snow is white”). But some are neither true nor false. Imperatives (i.e., orders—e.g., “get out of here”) and interrogatives (i.e., questions—e.g., “what’s a hypotenuse?) are

neither true nor false. True or false sentences are known as indicatives, and they therefore differ in respect of force from both interrogatives and imperatives.
...
Commentary: The sets that are of intellectual interest are usually ones whose members have some property in common with one another that nothing else

has in common with any of them. So, for example, we talk about the set of whole numbers, the set of people who have survived pancreatic cancer, the set of people who are currently philosophy professors. Let S1, S2, and S3 be

these three sets. Every member of S1 has the property of being a whole

number and nothing that isn’t a member of S1 has that property. Thus, the property of being a whole number generates S1. The property of being a survivor of pancreatic cancer and the property of being a philosophy professor generate S2 and S3, respectively.
...
Additional commentary: Sets ≠ properties: Some have held that sets are with properties. Their argument: “Smith is a person” (i.e., “Smith has the property of being a person”) is equivalent with “Smith is a member of the class of people,” and the same thing mutatis mutandis holds of any statement that attributes any property to anything.
...
(SS[7]) (1) is logically equivalent with (2). Therefore, (1) and (2) must co-refer, supposing that either refers to anything. (It is being assumed, very reasonably, that logically equivalent expressions cannot have different referents.)
...
If the occurrences in (1)–(4) “Mozart was a composer” and “Bill Clinton was U.S. President in 1997” are replaced with occurrences of any two true sentences, the argument that results is cogent. Thus, any

two true sentences co-refer, supposing that any true sentence refers to anything. (For the same reason mutatis mutandis, any two false sentences co-refer, supposing that any false sentence refers to anything.)

The property of being true is the one semantically significant thing that (1) and (4) have in common. So, supposing that sentences refer to anything, (1) and (4) must refer to the property of being true, and true sentences must in general be assumed to refer to the property of being true.[8] (For the same reason mutatis mutandis, false sentences must refer to the property of being false.[9])
...
that thing is self-identical; and there exists a class to which a thing belongs iff that thing is self-identical; and the first class is identical with the second class.
...
In his (ironically named) book Facing the Facts[11], Stephen Neale puts forth what he believes to be an improvement on SS.[12] Neale’s argument involves the following four assumptions:

G1: The sentence “Fa” stands for the same fact as the sentence “a=the unique

thing x such that (x = a and Fx).” (In this context, “=” is to be taken to mean “is identical with.”)
...
G4: Definite descriptions are referring terms. “The even prime” is an expression that picks out the number two.
...
1 and 4 stand for the same fact, namely F1. 2, 5, and 7 all stand for the same fact, namely F2. And 3 and 6 stand for the same fact, namely F3. “The unique

thing x such that (x = a and Fx)” co-refers with “the unique thing x such that (x = a and x ≠ b)”, since both expression refer to a. Therefore, 5 is what results when the definite description in 4 is replaced with a co-referring definite description. Therefore, 4 and 5 refer to the same fact. Since they refer, respectively, to F1 and F2, it follows that F1 and F2 are the same fact.

“The unique thing x such that (x = b and x ≠ a)” co-refers with “the unique thing x such that (x = b and Gx),” since both expressions refer to b. Therefore, 7 is what results when the definite description in 6 is replaced with a co-referring definite description. Therefore, 6 and 7 refer to the same fact. Since they refer, respectively, to F3 and F1, it follows that F3 and F1 are the

same fact. Now, if G4 is wrong, then definite descriptions are not referring

terms, which case 5 is not what results when the definite descriptions in 4 is replaced with a co-referring expression, and 7 is what not results when the definite description in 6 is replaced with a co-referring expression. But

assuming that G4 is right, we’ve established that F1 = F2. Therefore F1 = F2 = F3, and “Fa” therefore co-refers with “Gb” and also with “a ≠ b.” So,

assuming that definite descriptions are what they appear to be, viz. referring terms, it follows there is only one fact.

As Neale points out, this result, if it is in fact true, is astonishing. But, as Neale then points out, G2 allows us to go further. Let S and S* be any two

distinct statements that are true. (So S and S* needn’t have subject-predicate form.) According to G2, S and be put in subject-predicate form, and so can
...
Speech act[13]: Assertions are speech acts, and so are promises, orders, exhortations, and so on. A rough definition of “speech act” is “any case of somebody’s deliberately uttering or otherwise tokening a sentence.”
...
(1) “snow is white” is not equivalent with
...
Universal generalization: A sentence expresses a “universal generalization” if the main connective of that sentence is a universal quantifier.[14] A connective is an expression that, when given a sentence, or open sentence, or ordered n-tuple of (open) sentences, yields a new sentence. Thus “and” is a
...
Commentary: Many statements that seem to be conditionals are not, and are instead universal generalizations. For example if a thing likes apples, it is friendly, is a universal generalization, not a conditional. The reason: it’s identical with the proposition: all things are such that they are friendly if they like apples. Put another way, it’s identical with: for any x, if x likes apples, x is friendly. Thus, the “main connective” of the sentence “if a thing likes

apples, it is friendly” isn’t “if,” and is instead “for any object x”; and for this reason, it’s a universal generalization, not a conditional.
...
[5]. For example, Peter Strawson in his otherwise brilliant (1950) paper “On referring.”

[6]. The sentence “this is radically absurd” occurs in Russell’s (1903) book Principles of Mathematics (PM). (It occurs in the chapter on Newton’s laws of motion.) I rather fancy this sentence, and thus use it from time to time. Ironically, the statement that Russell describes as “radically absurd” in PM is, as I recall, quite a defensible one.

[7]. “SS” is short for “Slingshot.”

[8]. Advocates of this argument say that the true sentences refer to The True, and that false sentences refer to The False. They don’t say what these terms mean. In an effort to free their argument of needless obscurities and

indefensible assumptions, I’ve taken the liberty of assuming that they refer to the properties of being true and false, respectively.

[9]. Give or take some irrelevant details, this argument was put forth by Frege in his landmark paper On sense and reference.

[10]. See his paper “True to the facts,” in the (1984) collection of his papers Essays on Truth and Interpretation.

[11]. Oxford University Press, 2005.

[12]. In what follows, I use actual quotation marks where I should, stricty speaking, use quasi-quoatatoin marks.

[13]. To my knowledge, this term was coined by John Searle. It is the title of his excellent (1969) book Speech acts.

[14]. Examples of universal quantifiers are “for all x,” “given any x,” “any object,” “all objects,” and so on. (In general, a universal quantifier is an expression E such that, in virtue of having the form ‹...E...›, a sentence expresses a proposition to the effect that all members of some one class are members of some other class. Thus, “for all x, if x is a dog, then x is a mammal” is to the effect that every member of the class of dogs is a member of the class of mammals.`
    }
  ]
};
